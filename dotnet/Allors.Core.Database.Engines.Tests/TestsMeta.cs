...
public sealed class TestsMeta
{
    ...
    public TestsMeta(CoreMeta m)
    {
        ...
        this.I1 = m.AddInterface(new Guid("57F22F6E-640A-4F70-BFD8-B205BC9BAF68"), "I1");
        this.I2 = m.AddInterface(new Guid("E3B0C7A5-172D-41BB-9003-3F83671340D4"), "I2");
        this.I12 = m.AddInterface(new Guid("F7983E4F-CAE4-498F-900E-DAFADCE24F1B"), "I2");
        this.S1 = m.AddInterface(new Guid("1E98E9B0-A749-45E4-8218-968A716D9EA2"), "S1");
        this.S2 = m.AddInterface(new Guid("BE622486-50F2-44C8-9BD8-549A2145CD62"), "S2");

        this.C1 = m.AddClass(new Guid("840A24C6-7E62-4540-87FD-69284FD58935"), "C1");
        this.C2 = m.AddClass(new Guid("800483A5-E060-4AA3-9070-81110F8D78DF"), "C2");
        this.C3 = m.AddClass(new Guid("3F819AFC-A9BE-4CF7-B049-23463B0ED383"), "C3");
        ...
        (this.C1WhereC2OneToOne, this.C1C2OneToOne) = m.AddOneToOneRelation(new Guid("CC911BE0-EA31-4192-9E4F-269A1B2051C9"), new Guid("9CE1875E-B8F3-4A0C-A4FC-B3AE439CBE1F"), this.C1, this.C2, "C2OneToOne");
        (this.C1WhereI2OneToOne, this.C1I2OneToOne) = m.AddOneToOneRelation(new Guid("84A18359-0BA3-4074-B111-CBD00069B657"), new Guid("B520451B-7055-49AF-9BA1-3A07CC1BD257"), this.C1, this.I2, "I2OneToOne");
        (this.C1WhereS2OneToOne, this.C1S2OneToOne) = m.AddOneToOneRelation(new Guid("F8E094DD-3D9E-45DD-869A-F20DFF609F0D"), new Guid("E5069995-CF03-4A8A-BADB-7CA85AE85AA4"), this.C1, this.S2, "S2OneToOne");
        (this.C2WhereC1OneToOne, this.C2C1OneToOne) = m.AddOneToOneRelation(new Guid("1CDC24F5-9D1D-42AC-AD6F-4FDED79E915E"), new Guid("5A548C31-1F7E-443E-A0E8-E222572BF5D7"), this.C2, this.C1, "C1OneToOne");
