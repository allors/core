...
{
    internal MetaManyToManyAssociationType(Guid id, MetaObjectType objectType, MetaManyToManyRoleType roleType, string singularName, string pluralName, string name)
    {
        this.Id = id;
